...
public class PrintingMessagesOnConsole {
    ...
    static final int EXIT_PROGRAM = 4;
    ...
    void printFirstChoice() {
        ...
        System.out.print(" \n Enter 1 for Adding a contact details, 2 for Printing details, 3 for editing and any other number to terminate : ");
    }

    public void takingInputOverCases() {

        System.out.print(" \n Enter 1 for Adding a contact details, 2 for Printing details, 3 for editing and other number to terminate : ");
        choiceOfUsers = choice.nextInt();
        if (choiceOfUsers < 0 || choiceOfUsers > 4)
